   ...
   rightButtonTitle:(NSString *)rigthTitle
{
    if (self = [super init]) {
        ...
        self.backgroundColor = [UIColor colorWithRed:242.0/255.0 green:93.0/255.0 blue:56.0/255.0 alpha:1];
        ...
        self.alertContentLabel = [[UILabel alloc] initWithFrame:CGRectMake((kAlertWidth - contentLabelWidth) * 0.5,
                                                                           CGRectGetMaxY(self.alertTitleLabel.frame),
                                                                           contentLabelWidth,
                                                                           60)];
...
#define kButtonBottomOffset 10.0f
        ...
        [self.rightBtn setBackgroundImage:[UIImage imageWithColor:[UIColor colorWithRed:248.0/255.0 green:118.0/255.0 blue:70.0/255.0 alpha:1]] forState:UIControlStateNormal];
        [self.leftBtn setBackgroundImage:[UIImage imageWithColor:[UIColor colorWithRed:252.0/255.0 green:108.0/255.0 blue:64.0/255.0 alpha:1]] forState:UIControlStateNormal];
